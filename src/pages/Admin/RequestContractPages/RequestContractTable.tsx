...
import { IContract, IRequestContract } from "../../../interfaces";
...
import { getRequestContractStatusColor } from "../../../utils/getMethodColor";
...
const RequestContractTable: React.FC<Props> = ({
  ...
  const columns = [
...

    {
      ...
      render: (_: any, record: IRequestContract) => (
        <p
          className={`font-bold ${getRequestContractStatusColor(
            record?.status
          )}`}
        >
          {record?.status}
