...
import { contractApi, invoiceApi, roomApi } from "../../../api";
import { Card, notification, Result, Skeleton } from "antd";
import CountUp from "react-countup";
import { InvoiceStatus } from "../../../enums";
import DetailRoom from "../../Admin/RoomPages/DetailRoom";
...
export default function RoomContract() {
    ...
    return (
        ...
        <DetailRoom record={roomInfor} openDetailRoom={openDetail} setOpenDetailRoom={setOpenDetail} />
        </div>
    );
