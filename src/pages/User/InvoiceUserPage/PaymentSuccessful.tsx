      ...
      <div className="bg-white rounded-lg p-8 shadow-lg text-center">
        ...
        <div className="space-y-4 mb-6">
          <div>
            ...
            <p className="text-gray-700">{transactionDetails.senderName}</p>
          </div>
          <div>
            <p className="text-sm font-semibold">Ngân hàng người gửi:</p>
            <p className="text-gray-700">{transactionDetails.senderBank}</p>
          </div>
          <div>
            <p className="text-sm font-semibold">Tên người nhận:</p>
            <p className="text-gray-700">{transactionDetails.receiverName}</p>
          </div>
          <div>
            <p className="text-sm font-semibold">Ngân hàng người nhận:</p>
            <p className="text-gray-700">{transactionDetails.receiverBank}</p>
          </div>
          <div>
            <p className="text-sm font-semibold">Số tiền chuyển:</p>
            <p className="text-gray-700">{transactionDetails.amount}</p>
          </div>
          <div>
            <p className="text-sm font-semibold">Nội dung chuyển:</p>
