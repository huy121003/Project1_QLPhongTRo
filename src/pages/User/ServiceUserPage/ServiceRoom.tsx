...
const ServiceRoom = ({
  ...
  const fetchRoomData = async (roomId: string) => {
    try {
      const res = await roomApi.fetchRoomApi(`_id=${roomId}&populate=services`);
      ...
      <table className="w-full border text-center border-collapse">
        <thead>
          <tr className="border">
            ...
            <th className="py-2 px-4 border-r text-lg">Description</th>
            <th className="py-2 px-4 text-lg">Cancel registration</th>
          </tr>
        </thead>
        <tbody>
                ...
                <td className="py-2 px-4">
                  {registerService ? (
                    ...
                    <i
                      ...
                      onClick={() =>
                        handleDeleteService(service._id, service.type)
                      }
                    ></i>
                  ) : null}
                </td>
