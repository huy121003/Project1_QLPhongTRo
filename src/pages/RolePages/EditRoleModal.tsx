...
import { Modal, Button, Input, Form, message, Select, DatePicker, Collapse, Tag, Switch } from "antd";
...
const EditRoleModal: React.FC<Props> = ({ openEditRole, setOpenEditRole, record }) => {
